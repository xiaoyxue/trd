...
//! rendered by spawning the [`WasmRenderer`]'s async `render` on the microtask
...
pub struct WebApp {
    ...
    renderer: Rc<RefCell<Option<WasmRenderer>>>,
...
impl WebApp {
    ...
    pub fn new(controller: InteractionController, renderer: WasmRenderer) -> Self {
